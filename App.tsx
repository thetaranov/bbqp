...
opacity: 0, // Initial opacity controlled by keyframes
...
// Increased count slightly for better effect
for (let i = 0; i < 16; i++) {
let placed = false, attempts = 0;
while (!placed && attempts < 2000) {
// Wider spread for starting positions
...
left: l,
top: t,
// Faster duration for "comet" speed (3s to 7s)
